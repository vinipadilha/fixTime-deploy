        ...
        if ($result && $result->num_rows > 0) {
            ...
            foreach ($oficinas as $row) {
                ...
                <div class="mb-8 py-6 px-8 border border-gray-200 rounded-lg shadow-sm bg-white hover:shadow-lg">
                    ...
                    <a href="/src/views/main-page/Cliente/agendamento-cliente.php?id_oficina=<?= $row['id_oficina'] ?>" class="mt-2 text-white inline-flex items-center justify-center gap-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center cursor-pointer col-span-3">
