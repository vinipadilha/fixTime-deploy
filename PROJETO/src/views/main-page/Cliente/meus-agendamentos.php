...
<body class="">
        ...
        <div class="h-full px-3 py-4 bg-gray-50 flex flex-col justify-between">
            ...
            <div>
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="/src/views/main-page/Cliente/prestadores-servico.php" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                    ...
                    <li>
                        <a href="/src/views/main-page/Cliente/veiculos.php" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                            <svg class="shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900" data-slot="icon" fill="none" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="/src/views/main-page/Cliente/meus-agendamentos.php" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                    ...
                    <li>
                        <a href="/src/views/main-page/Cliente/perfil.php" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                            <svg class="shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900" data-slot="icon" fill="none" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="lg:ml-64 p-4 lg:px-20 lg:py-4">
        ...
        <?php if (!empty($servicos)): ?>
            ...
            <form method="POST" action="/src/views/main-page/Cliente/salvar_reagendamento.php" class="form-agendamento">
            ...
            <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md ">
                ...
                <div class="">
                    ...
                    <form method="POST" action="/src/views/main-page/Cliente/excluir_agendamento.php" class="excluir-form" style="display: none;">
                        <input type="hidden" name="id_servico" value="<?= $servico['id_servico'] ?>">
                    </form>


                    <div class="">
                        <form method="POST" action="/src/views/main-page/Cliente/salvar_avaliacao.php" class="avaliacao-oficina">
                            <input type="hidden" name="id_servico" value="<?= $servico['id_servico'] ?>">
                ...
                <div class="mt-10 p-4 rounded-lg bg-gray-100 border-2 border-gray-300 shadow-xl flex items-center justify-between">
                    <div>
                        ...
                        <p class="font-medium">Dê uma olhada nos nossos parceiros cadastrados,
                            <a class="text-blue-600 font-semibold underline hover:text-blue-800" href="/src/views/main-page/Cliente/prestadores-servico.php">clique aqui.</a>
                        </p>
                    </div>
                </div>
            <?php endif; ?>
